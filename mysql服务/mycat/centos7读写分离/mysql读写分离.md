...
## 11、配置MyCAT
 ...
 ![1562217920081](images/1562217920081.png)
...
```
 ...
 ![1562218031828](images/1562218031828.png)
...
![1562218132197](images/1562218132197.png)
...
## 2、测试查看管理监控端 9066（负责管理后端）
 ...
 ![1562218476610](images/1562218476610.png)

可以查看各数据库服务器的状态：

 ![1562218445668](images/1562218445668.png)
...
bug说明：
 ...
 ![1567749063275](images/1567749063275.png)

① balance =1

② 两个writehost可以解决 w对应的master不可用时，slave可读可写

 ![1562219193203](images/1562219193203.png)
...
扩展：使用switchType实现数据库高可用

第一步：给MySQL01与MySQL02拍摄一个快照（非常重要）

第二步：更改MyCAT的conf/schema.xml配置文件，引入第二个writeHost节点
...
![image-20200109094340156](images/image-20200109094340156.png)

第三步：设置完成后，保存，重启MyCAT，开启debug调试模式，观察mycat.log变化
